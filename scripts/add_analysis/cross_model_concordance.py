...
Usage:
    ...
    python scripts/analysis/cross_model_concordance.py \
        --results_root results --output_dir results/add_analysis/cross_model
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/add_analysis/cross_model"))
