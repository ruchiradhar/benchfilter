...
Examples:
    ...
    python scripts/analysis/gsm_1pl/rank_consistency_1pl.py --results_dir results/1PL --output_dir results/add_analysis/gsm_1pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/add_analysis/gsm_1pl"))
