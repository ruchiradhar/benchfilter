...
Examples:
    ...
    python scripts/analysis/gsm_2pl/rank_consistency_2pl.py --results_dir results/2PL --output_dir results/add_analysis/gsm_2pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/add_analysis/gsm_2pl"))
