...
Usage:
    ...
    python scripts/analysis/cross_model_iif_concordance.py \
        --results_root results --output_dir results/add_analysis/cross_model_iif \
        --top_frac 0.5
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/add_analysis/cross_model_iif"))
