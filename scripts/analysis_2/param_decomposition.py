...
Outputs:
  results/analysis_2/param_decomposition/summary.csv
  results/analysis_2/param_decomposition/summary_table.txt
"""
...
OUTPUT_DIR   = RESULTS_ROOT / "analysis_2" / "param_decomposition"
