...
Examples:
    ...
    python scripts/analysis/gsm/rank_consistency_3pl.py --results_dir results/3PL --output_dir results/analysis_2/gsm_3pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/analysis_2/gsm_3pl"))
