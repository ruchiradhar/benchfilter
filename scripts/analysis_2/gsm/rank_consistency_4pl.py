...
Examples:
    ...
    python scripts/analysis/gsm_4pl/rank_consistency_4pl.py --results_dir results/4PL --output_dir results/analysis_2/gsm_4pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/analysis_2/gsm_4pl"))
