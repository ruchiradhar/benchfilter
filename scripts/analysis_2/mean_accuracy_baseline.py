...
Produces:
  results/analysis_2/mean_accuracy_baseline/
...
OUTPUT_DIR   = RESULTS_ROOT / "analysis_2" / "mean_accuracy_baseline"
...
def load_heldout_irt_params(pl: str, stem: str) -> dict | None:
    ...
    path = (RESULTS_ROOT / "analysis_2" / "subset_ranking_fidelity_map" /
