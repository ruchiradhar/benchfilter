...
Saved held-out IRT params go to:
  results/analysis_2/subset_ranking_fidelity_map/heldout_irt/

All figures and CSVs saved to:
  results/analysis_2/subset_ranking_fidelity_map/
"""
...
OUTPUT_DIR   = PROJECT_ROOT / "results" / "analysis_2" / "subset_ranking_fidelity_map"
...
def main() -> None:
    ...
    insample_path = RESULTS_ROOT / "analysis_2" / "subset_ranking_fidelity" / "insample_fidelity.csv"
