...
Usage:
    ...
    python scripts/analysis/cross_model_concordance.py \
        --results_root results --output_dir results/core_analysis/cross_model
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/core_analysis/cross_model"))
