...
Examples:
    ...
    python scripts/analysis/gsm_2pl/rank_consistency_2pl.py --results_dir results/2PL --output_dir results/core_analysis/gsm_2pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--results_dir", type=Path, default=Path("results/2PL_map"))
    parser.add_argument("--output_dir", type=Path, default=Path("results/core_analysis/gsm_2pl"))
...
def main() -> None:
    ...
    shared_ylim = max(stab_diff.max(), stab_disc.max()) * 1.05
    plot_item_stability(stab_diff, "difficulty", ax4a, ylim=shared_ylim)
    plot_item_stability(stab_disc, "discrimination", ax4b, ylim=shared_ylim)
    fig4a.tight_layout()
