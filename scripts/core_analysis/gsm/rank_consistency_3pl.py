...
Examples:
    ...
    python scripts/analysis/gsm/rank_consistency_3pl.py --results_dir results/3PL --output_dir results/core_analysis/gsm_3pl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/core_analysis/gsm_3pl"))
