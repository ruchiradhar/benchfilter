...
MGSM_INDO_EUROPEAN = {"bn", "de", "en", "es", "fr", "ru"}  # Bengali is Indo-Aryan; rest are the tight cluster reported in the paper
MGSM_RESTRICTED = [l for l in MGSM_LANGUAGES if l not in MGSM_INDO_EUROPEAN]  # ja, sw, te, th, zh
...
def main() -> None:
    ...
    output_dir = PROJECT_ROOT / "results" / "core_analysis" / "correlated_raters"
